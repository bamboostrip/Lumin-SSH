...
import { IdentityPresetOption, buildIdentityOptionList, calcChmodOctal, normalizeChmodMode, permsFromChmodMode, resolveIdentityInputValue } from '../../utils/fileManagerHelpers.tsx';
...
// ── Chmod Dialog ──────────────────────────────────────────────
export function ChmodDialog({ path, permission, mode, rememberedMode = '', autoApplyLastSettings = false, uid, gid, ownerCandidates = [], groupCandidates = [], includeSubdirectories = false, showIncludeSubdirectories = false, onSave, onClose, t }: ChmodDialogProps) {
