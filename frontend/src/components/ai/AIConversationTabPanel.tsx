...
import { AIHomeView } from './AIHomeView.tsx'
...
export function AIConversationTabPanel({ width, side, terminalId = 'global', sessionId = '', sessionTerminals = [], workspaceTabId = '', isHomeView = false, isWorkspaceTabActive = true, showComposer = true, initialConversationId = '', tabBar = null, onDevilModeChange, onGoHomeRequested, onOpenConversationRequested, onWorkspaceTabStateChange, addToast }: AIPanelProps) {
  ...
  const renderedConversationList = useMemo(() => (
    <AIHomeView
      ...
      conversationOrganizer={conversationOrganizer}
      conversationFilter={conversationFilter}
      conversationSelectionMode={conversationSelectionMode}
      selectedConversationIds={selectedConversationIds}
      editingConversationGroupId={editingConversationGroupId}
      editingConversationGroupName={editingConversationGroupName}
      draggingConversationGroupId={draggingConversationGroupId}
      dragOverConversationGroupId={dragOverConversationGroupId}
      moveToGroupOpen={moveToGroupOpen}
      isDevilMode={isDevilMode}
      globalSearchOpen={globalSearchOpen}
      globalSearchQuery={globalSearchQuery}
      normalizedGlobalSearchQuery={normalizedGlobalSearchQuery}
      globalSearchLoading={globalSearchLoading}
      globalSearchResults={globalSearchResults}
      panelState={panelState}
      globalSearchInputRef={globalSearchInputRef}
      conversationGroupRenameInputRef={conversationGroupRenameInputRef}
      setGlobalSearchQuery={setGlobalSearchQuery}
      setConversationFilter={setConversationFilter}
      setConversationSelectionMode={setConversationSelectionMode}
      setEditingConversationGroupName={setEditingConversationGroupName}
      setDraggingConversationGroupId={setDraggingConversationGroupId}
      setDragOverConversationGroupId={setDragOverConversationGroupId}
      setMoveToGroupOpen={setMoveToGroupOpen}
      beginRenameConversationGroup={beginRenameConversationGroup}
      cancelRenameConversationGroup={cancelRenameConversationGroup}
      clearConversationSelection={clearConversationSelection}
      commitRenameConversationGroup={commitRenameConversationGroup}
      reorderConversationGroup={reorderConversationGroup}
      showSystemGroupRenameUnsupported={showSystemGroupRenameUnsupported}
      resetGlobalSearchState={resetGlobalSearchState}
      handleOpenGlobalSearch={handleOpenGlobalSearch}
      handleSelectGlobalSearchResult={handleSelectGlobalSearchResult}
      handleOpenConversation={handleOpenConversation}
      handleOpenConversationFolder={handleOpenConversationFolder}
      handleMakeConversationPermanent={handleMakeConversationPermanent}
      handleRenameConversationTitle={handleRenameConversationTitle}
      handleDeleteConversation={handleDeleteConversation}
      handleCreateConversationGroup={handleCreateConversationGroup}
      handleDeleteConversationGroup={handleDeleteConversationGroup}
      toggleConversationSelection={toggleConversationSelection}
      handleMoveSelectedConversations={handleMoveSelectedConversations}
      handleSetSelectedArchived={handleSetSelectedArchived}
      handleDeleteSelectedConversations={handleDeleteSelectedConversations}
    />
