...
[![Download](https://img.shields.io/github/downloads/dag6608/Lumin-SSH/total?style=for-the-badge&color=2EA043&label=DOWNLOAD%20LATEST)](https://github.com/dag6608/Lumin-SSH/releases)
...
LuminSSH is a terminal tool I whipped up in my spare time.
...
- 📥 **Cloud Sync (WebDAV / R2 / FTP / SFTP)**
  ...
  - Connect to a new machine or change a password, and the background agent will silently encrypt and upload a snapshot to WebDAV, Cloudflare R2, FTP, or SFTP, allowing for one-click restoration anytime.
