...
const BASE =
  'inline-flex items-center justify-center gap-1 rounded-sm text-sm font-medium leading-none whitespace-nowrap border select-none cursor-pointer outline-none transition-colors duration-100 focus-visible:ring-2 focus-visible:ring-accent/50 disabled:opacity-45 disabled:pointer-events-none';
